...
namespace DiceRoller.Tests
{
    ...
    public class ConsoleMockingTests
    {
        ...
        public void DiceRollerRepository_ComplexDiceChoice_ShouldSelectCorrectOption(string input, string input2, string input3, string input4, string input5, string input6, string assert)
        {
            //-- Arrange
        ...
        public void DiceRollerRepository_ComplexMultipleDiceChoice_ShouldSelectForMoreDice(string input, string input2, string input3, string input4, string input5, string input6, string input7, string assert)
        {
            //-- Arrange
        ...
        public void DiceRollerRepository_ComplexMultipleDiceChoice_ShouldNotSelectForMoreDice(string input, string input2, string input3, string input4, string input5, string input6, string assert)
        {
            //-- Arrange
            var commandList = new List<string> { input, input2, input3, input4, input5, input6 };
            MockConsole console = new MockConsole(commandList);
        ...
        public void DiceRollerRepository_ComplexRollDiceAgain_ShouldContainExitMessage(string input, string input2, string input3, string input4, string input5, string input6, string assert)
        {
            //-- Arrange
            var commandList = new List<string> { input, input2, input3, input4, input5, input6 };
            MockConsole console = new MockConsole(commandList);
